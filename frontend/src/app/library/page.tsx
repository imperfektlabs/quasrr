...
function LibraryContent() {
  ...
  const librarySearchStickyClass = librarySearchAtBottom ? 'sticky bottom-4' : 'sticky top-16'
    ...
    <main className="min-h-screen pt-16 px-4 pb-8 md:px-8">
      ...
      <div className="max-w-5xl mx-auto space-y-4">
        <section className="space-y-3">
          {(() => {
            const searchPanel = (
              <div className={`${librarySearchStickyClass} z-20`}>
                <div className="glass-panel rounded-lg p-3 space-y-3 relative">
                  ...
                  <button
                    ...
                    aria-label={librarySearchAtBottom ? 'Pin search to top' : 'Pin search to bottom'}
                  >
                    {librarySearchAtBottom ? (
